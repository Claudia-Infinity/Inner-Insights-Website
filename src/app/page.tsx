...
const GROWTH: Service[] = [
  ...
  { slug: "discovery-call",     title: "Discovery Call",         img: "/images/claudia/Red Glasses Sweatshirt.png",  blurb: "A free Zoom discovery call to illuminate your path and explore how coaching or mentorship can support your next evolution.", href: "https://innerinsights.simplybook.me/v2/#book/service/26", objectPosition: "50% 15%" },
...
const BUNDLES: Service[] = [
  {
    ...
    img: "/images/services/bundle-card-reading-phone.jpeg",
  ...
  },
  {
    ...
    img: "/images/services/bundle-energy-healing-phone.jpeg",
  ...
  },
  {
    ...
    title: "3 Energy Healing Bundle",
    img: "/images/services/bundle-energy-healing-zoom.jpeg",
