...
const TESTIMONIALS = [
  ...
  { quote: "I thoroughly enjoyed taking the 3-Month VIP Coaching course with Claudia. The program is very well organized and laid out to keep you on track with your goals. Claudia is extremely knowledgeable and very pleasant to work with.", name: "Christi McDonald", role: "Counselor & Life Coach · Grapevine, TX",                       photo: "/images/testimonials/Christi McDonald.jpg", objectPosition: "center 30%" },
  { quote: "Claudia's insight, discipline, and spiritual gifts make her an amazing coach. I got much out of these sessions and would highly recommend. You have to do the work, though — she holds you accountable. The best coach to have.", name: "Zuraya Tapia-Hadley", role: "Senior Government & Public Affairs Professional · Arlington, VA", photo: "/images/testimonials/Zuraya Tapia-Hadley.jpg", objectPosition: "center 30%" },
